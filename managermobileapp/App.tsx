...
// Screens
import { LoginScreenView } from "./src/components/LoginScreen";
import { InvestigationScreenView } from "./src/components/InvestigationScreen";
import { AssignActionsScreenView } from "./src/components/AssignActionsScreen";
import { ComplianceApprovalsView } from "./src/components/ComplianceApprovals";
import { PermitApprovalsView } from "./src/components/PermitApprovals";
import { AppContainerView } from "./src/components/AppContainer";
...
function App() {
  ...
  const handleFinalizeActions = () => {
    ...
    const newCapaItems: Capa[] = queuedActions.map((action, idx) => ({
